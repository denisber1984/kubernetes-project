...
class ImageProcessingBot(Bot):
    def handle_message(self, msg):
        ...
        if self.is_current_msg_photo(msg):
            ...
            self.send_text(msg['chat']['id'], f"Hello {first_name}! Please upload your photo and specify the filter you'd like me to apply.\nSupported filters are: blur, contour, rotate, segment, salt and pepper, concat, brightness, contrast.")
